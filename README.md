# RetailIQ — Apple 門市銷售訓練系統

> **Apple Internal** · 銷售訓練用 LLM-maintained 知識平台
> **Status**: 🎯 **v0.6 shipped** — Full 5-gate pipeline + Gate 4 structural diff-merge（Schema v2.0）
